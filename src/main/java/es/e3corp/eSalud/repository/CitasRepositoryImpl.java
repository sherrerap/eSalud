...
public class CitasRepositoryImpl implements CitasRepository {
	...
	public List<Cita> findPaciente(final String dni) {
		final List<Cita> citas = this.mongoOperations.find(new Query(Criteria.where("paciente").is(Utilidades.encriptar(dni))),
				Cita.class);
	...
	public List<Cita> findMedico(final String id) throws ParseException {
		...
		for (Cita cita : citasDesencriptadas) {
			Usuario u = this.mongoOperations.findOne(
					new Query(Criteria.where("dni").is(Utilidades.encriptar(cita.getPaciente()))), Usuario.class);
	...
	public List<Cita> getCitasDisponibles(String idmedico, String dia) {
		...
		final Usuario usuario = this.mongoOperations
				.findOne(new Query(Criteria.where("dni").is(idmedicoEncriptado)), Usuario.class);
