...
public class Eliminar_CitasSteps {
	...
	Cita cita = new Cita("DATOS DE LA NUEVA CITA");*/
	
	@Given("el usuario de ha logueado y elegirá la cita que quiera eliminar")
	public void el_usuario_de_ha_logueado_y_elegirá_la_cita_que_quiera_eliminar(io.cucumber.datatable.DataTable dataTable) {
